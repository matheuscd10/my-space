<template>
  <v-layout row justify-center align-center wrap class="mt-4 pt-2">
          ...
          <v-timeline-item color="green" small>
            <v-layout pt-3>
              ...
              <v-flex class="pl-2">
                ...
                <div class="caption mb-2">Unoesc</div>
              </v-flex>
            </v-layout>
          </v-timeline-item>
        </v-timeline>
      ...
      <v-card-text class="py-0">
        <v-timeline align-top dense>
          <v-timeline-item color="green" small>
            <v-layout pt-3>
              <v-flex xs4>
                <div class="caption font-weight-bold green--text">JAN 2023 -</div>
                <div class="caption font-weight-bold green--text">PRESENT</div>
              </v-flex>
              <v-flex class="pl-2">
                <strong>Looking for first experience as a developer</strong>
    ...
    <v-layout row justify-center align-center wrap class="mt-4 pt-2">
      ...
      <div class="mt-4 pt-2">
        <v-btn
          href="https://drive.google.com/file/d/1jFfc_6CWf15686sMUrrsOzZJu_LBYjRH/view?usp=share_link"
          target="_blank"
          color="green"
          dark
          large
